...
export const PricingPage: React.FC<PricingPageProps> = ({
  ...
  const fetchPlans = async () => {
    try {
      ...
      // WORLD-FIRST PRICING - Premium for predictive CVE intelligence
      setPlans([
        {
          tier: 'FREE',
          name: 'Free',
        ...
        },
        {
          ...
          highlight: 'Perfect for indie developers',
        },
        {
          tier: 'PRO',
          name: 'Pro',
          ...
          highlight: 'Most popular - Predictive AI Security',
        },
        {
          tier: 'TEAM',
          name: 'Team',
          ...
          yearlyPriceFormatted: '$2,390',
          yearlySavings: '$598',
          maxProjects: 50,
          maxScansPerMonth: 2500,
          maxTeamMembers: 10,
          maxAIQueries: 10000,
          features: [
            '50 projects',
            ...
            '🔮 All Predictive AI features',
            'Team dashboard',
            'Role-based access',
            'Audit logs',
            'Jira integration',
          ],
          highlight: 'Real-time security collaboration',
        },
        {
          tier: 'BUSINESS',
          name: 'Business',
          monthlyPrice: 79900,
          yearlyPrice: 767000,
          monthlyPriceFormatted: '$799',
          yearlyPriceFormatted: '$7,670',
          yearlySavings: '$1,918',
          maxProjects: 200,
          ...
          highlight: 'Enterprise-grade for mid-market',
        },
        {
          tier: 'ENTERPRISE',
          name: 'Enterprise',
        ...
        },
        {
          ...
          features: [
            ...
            'Dedicated gov account team',
            'Congressional briefing support',
          ],
          highlight: 'Secure government operations',
        },
      ]);
    } finally {
      setLoading(false);

...
export const PricingPage: React.FC<PricingPageProps> = ({
  ...
  const fetchPlans = async () => {
    try {
      ...
      // WORLD-FIRST PRICING - Premium for 109 modules & 32 world-first features
      setPlans([
        {
          tier: 'FREE',
          name: 'Free',
        ...
        },
        {
          ...
          monthlyPrice: 99000,
          yearlyPrice: 950000,
          monthlyPriceFormatted: '$990',
          yearlyPriceFormatted: '$9,500',
          yearlySavings: '$2,380',
          maxProjects: 3,
          maxScansPerMonth: 50,
          maxTeamMembers: 1,
        ...
        },
        {
          ...
          monthlyPrice: 499000,
          yearlyPrice: 4790000,
          monthlyPriceFormatted: '$4,990',
          yearlyPriceFormatted: '$47,900',
          yearlySavings: '$12,100',
          maxProjects: 10,
        ...
        },
        {
          ...
          monthlyPriceFormatted: '$14,990',
          yearlyPriceFormatted: '$143,900',
          yearlySavings: '$35,980',
          maxProjects: 50,
        ...
        },
        {
          ...
          yearlyPrice: 28790000,
          monthlyPriceFormatted: '$29,990',
          yearlyPriceFormatted: '$287,900',
          yearlySavings: '$71,980',
          maxProjects: 200,
          ...
          highlight: 'Complete security platform — All 32 World-Firsts',
        },
        {
          tier: 'ENTERPRISE',
          name: 'Enterprise',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-block px-4 py-1 bg-linear-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-full text-cyan-400 text-sm font-medium mb-4">
            🏆 109 MODULES • 32 WORLD-FIRST FEATURES • 32 UNPROTECTED LAYERS
          </div>
          ...
          <p className="text-xl text-purple-300 max-w-2xl mx-auto">
            The world&apos;s most complete security platform. 32 world-first features that don&apos;t exist anywhere else. You&apos;re not buying a tool — you&apos;re buying a monopoly.
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                ...
                <p className="text-cyan-300">
                  ...
                  <span className="text-purple-300 ml-2">Invite 3 devs → Get Pro free for life!</span>
                  <span className="text-yellow-400 ml-2 text-sm font-bold animate-pulse">⚡ First 50 customers only!</span>
                </p>
              </div>
              <button
            ...
            <div className="bg-linear-to-br from-gray-900 via-purple-900/30 to-gray-900 border border-cyan-500/30 rounded-2xl p-8 max-w-md w-full backdrop-blur-xl">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="bg-linear-to-r from-pink-500/20 to-cyan-500/20 border border-pink-500/50 rounded-lg p-4">
                  <p className="text-white font-bold mb-1">🏆 Invite 3 Devs = Pro FREE For Life!</p>
                  <p className="text-cyan-300 text-sm">Get 3 friends on paid plans and unlock Pro for life — <span className="text-yellow-400 font-bold">limited to first 50 customers only!</span></p>
                </div>
              </div>
        ...
        <div className="mb-16 max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-cyan-400 mb-2">🏆 32 World-First Features — No Other Vendor Has These</h2>
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-black/40 border border-pink-500/30 rounded-xl p-6 backdrop-blur-sm">
              ...
              <p className="text-purple-300">
                Share your link, friends get 1 month free. You get 1 month free when they subscribe. Get 3 friends on paid plans = Pro free for life! This exclusive offer is limited to the first 50 customers only — once they're gone, they're gone.
              </p>
            </div>
            <div className="bg-black/40 border border-cyan-500/30 rounded-xl p-6 backdrop-blur-sm">
              <h3 className="text-lg font-semibold text-cyan-400 mb-2">

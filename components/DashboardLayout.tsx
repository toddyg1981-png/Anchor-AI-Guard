  ...
  const navCategories: Array<{ category: string; icon: string; pillar?: string; items: NavItem[] }> = [
    ...
    // ─────────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        { id: 'dns-security', label: 'DNS Security', icon: '🌍', view: 'dnsSecurity', description: 'DNS filtering & sinkholing' },
        { id: 'waf', label: 'Web App Firewall', icon: '🧱', view: 'waf', description: 'WAF with AI inspection' },
        { id: 'ddos-protection', label: 'DDoS Protection', icon: '🌊', view: 'ddosProtection', description: 'Multi-layer DDoS mitigation' },
        { id: 'iot-security', label: 'IoT Security', icon: '📡', view: 'iotSecurity', description: 'IoT device hardening' },
        { id: 'patch-mgmt', label: 'Patch Management', icon: '🩹', view: 'patchManagement', description: 'Automated patch orchestration' },
        { id: 'privileged-access', label: 'Privileged Access (PAM)', icon: '🔐', view: 'privilegedAccess', description: 'JIT access & session recording' },
        { id: 'secure-code-review', label: 'Secure Code Review', icon: '📝', view: 'secureCodeReview', description: 'Security-first peer review' },
      ],
    },
    ...
    // ─────────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        { id: 'casb', label: 'CASB', icon: '☁️', view: 'casbSecurity', description: 'Cloud access security broker' },
        { id: 'siem', label: 'SIEM Platform', icon: '📊', view: 'siemPlatform', description: 'Centralized log & correlation' },
        { id: 'ai-agent-sec', label: 'AI Agent Security', icon: '🤖', view: 'aiAgentSecurity', description: 'Autonomous agent guardrails', worldFirst: true },
        { id: 'deepfake-detection', label: 'Deepfake Detection', icon: '🎭', view: 'deepfakeDetection', description: 'Voice & video deepfake defense', worldFirst: true },
        { id: 'satellite-comms', label: 'Satellite Comms', icon: '🛰️', view: 'satelliteComms', description: 'Space comms encryption', worldFirst: true },
        { id: 'llm-supply-chain', label: 'LLM Supply Chain', icon: '🔗', view: 'llmSupplyChain', description: 'Model provenance & poisoning', worldFirst: true },
      ],
    },
    ...
    // ─────────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        { id: 'privacy-impact', label: 'Privacy Impact (DPIA)', icon: '🔏', view: 'privacyImpact', description: 'GDPR DPIA & data mapping' },
      ],
    },
  ];

...
export default function AnchorIntelligenceLanding({ onBack }: { onBack?: () => void }) {
  ...
  const loadPlans = async () => {
    try {
      ...
      setPlans([
        { tier: 'starter', name: 'Starter API', monthlyPrice: 49990, monthlyPriceFormatted: '$49,990', yearlyPrice: 479900, yearlyPriceFormatted: '$479,900', rateLimit: '60 req/min', monthlyQuota: '10,000', permissions: ['threat-intel', 'rule-generation'], description: 'Basic threat intelligence and rule generation' },
        { tier: 'professional', name: 'Professional API', monthlyPrice: 249990, monthlyPriceFormatted: '$249,990', yearlyPrice: 2399900, yearlyPriceFormatted: '$2,399,900', rateLimit: '300 req/min', monthlyQuota: '100,000', permissions: ['threat-intel', 'rule-generation', 'ai-analysis', 'predictive', 'competitive-intel'], description: 'Full AI analysis, prediction, and competitive intelligence' },
        { tier: 'enterprise', name: 'Enterprise API', monthlyPrice: 999990, monthlyPriceFormatted: '$999,990', yearlyPrice: 9599900, yearlyPriceFormatted: '$9,599,900', rateLimit: '1,000 req/min', monthlyQuota: '1,000,000', permissions: ['threat-intel', 'rule-generation', 'ai-analysis', 'predictive', 'competitive-intel', 'white-label', 'custom-models', 'webhooks'], description: 'White-label AI, custom models, and unlimited capabilities' },

...
export default function AnchorIntelligenceLanding() {
  ...
  const loadPlans = async () => {
    try {
      ...
      setPlans([
        { tier: 'starter', name: 'Starter API', monthlyPrice: 4999, monthlyPriceFormatted: '$4,999', yearlyPrice: 47990, yearlyPriceFormatted: '$47,990', rateLimit: '60 req/min', monthlyQuota: '10,000', permissions: ['threat-intel', 'rule-generation'], description: 'Basic threat intelligence and rule generation' },
        { tier: 'professional', name: 'Professional API', monthlyPrice: 24999, monthlyPriceFormatted: '$24,999', yearlyPrice: 239990, yearlyPriceFormatted: '$239,990', rateLimit: '300 req/min', monthlyQuota: '100,000', permissions: ['threat-intel', 'rule-generation', 'ai-analysis', 'predictive', 'competitive-intel'], description: 'Full AI analysis, prediction, and competitive intelligence' },
        { tier: 'enterprise', name: 'Enterprise API', monthlyPrice: 99999, monthlyPriceFormatted: '$99,999', yearlyPrice: 959990, yearlyPriceFormatted: '$959,990', rateLimit: '1,000 req/min', monthlyQuota: '1,000,000', permissions: ['threat-intel', 'rule-generation', 'ai-analysis', 'predictive', 'competitive-intel', 'white-label', 'custom-models', 'webhooks'], description: 'White-label AI, custom models, and unlimited capabilities' },
